...
public:
    ...
    Armour(Piece head, Piece chest, Piece arms, Piece legs): helmet(head), breastplate(chest), gauntlets(arms), greaves(legs),
    ...
    void setValues(Piece head, Piece chest, Piece arms, Piece legs);


    //Getters
    Piece getHelmet() {return helmet;}
    Piece getBreastplate() {return breastplate;}
    Piece getGauntlets() {return gauntlets;}
    Piece getGreaves() {return greaves;}
