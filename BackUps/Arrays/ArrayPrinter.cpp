...
{
    Piece newHelmet(name, phys, mag, fire, light, type, weight);
    Resize(m_nLength + 1);
    m_padata[m_nLength] = newHelmet;
}

//void PieceArray::Export2(string fileName)
//{
//    fstream iofile(fileName, ios::app);
//    for(int iii=0; iii < m_nLength; iii++)
//        iofile << "ID = " << iii << "\n"
//        << "Name = "<< m_padata[iii] << "\n"
//        << "Physical Def = " << m_padata[iii].getPhys() << "\n"
//        << "Magic Def = " << m_padata[iii].getMag() << "\n"
//        << "Fire Def = " << m_padata[iii].getFire() << "\n"
//        << "Lightning Def = " << m_padata[iii].getLight() << "\n"
//        << "Weight = " << m_padata[iii].getWeight() << "\n" << endl;
//
//        string output;
//        getline(iofile, output);
//        cout << output << endl;
//}
